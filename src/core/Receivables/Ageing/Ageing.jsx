...
export default function Agening({userRoles}) {
  ...
  React.useEffect(() => {
    if (Object.keys(userRoles?.['Customer Ageing'] || {})?.length > 0 && userRoles?.['Customer Ageing']?.view_receivable_ageing) {
      enableLoading(true);
      RestApi(
  ...
  }, [organization.orgId, user.activeToken, anchorElDate.value, value2, userRoles?.['Customer Ageing']]);
    ...
    if (device === 'mobile') {
      JSBridge.downloadWithAuthentication(
        `${BASE_URL}/organizations/${
          organization.orgId
        }/receivables/ageing.xlsx${value2 && `?report_view=${value2}`}`,
      );
    } else {
      enableLoading(true);
      fetch(
  ...
  const columnsAgeingDay = [
    ...
    },
    {
      ...
      renderCell: (params) => {
        return (
          <div onClick={() => handleClick(params.row.id, 'not_due_dr')}>
            <p
              style={{
                color:
    ...
    },
    {
      ...
      renderCell: (params) => {
        return (
          <div onClick={() => handleClick(params.row.id, '1_to_30_dr')}>
            <p
              style={{
                color:
    ...
    },
    {
      ...
      renderCell: (params) => {
        return (
          <div onClick={() => handleClick(params.row.id, '31_to_60_dr')}>
            <p
              style={{
                color:
    ...
    },
    {
      ...
      renderCell: (params) => {
        return (
          <div onClick={() => handleClick(params.row.id, '61_to_120_dr')}>
            <p
              style={{
                color:
    ...
    },
    {
      ...
      renderCell: (params) => {
        return (
          <div onClick={() => handleClick(params.row.id, '121_to_180_dr')}>
            <p
              style={{
                color:
    ...
    },
    {
      ...
      renderCell: (params) => {
        return (
          <div onClick={() => handleClick(params.row.id, '181_to_360_dr')}>
            <p
              style={{
                color:
    ...
    },
    {
      ...
      renderCell: (params) => {
        return (
          <div onClick={() => handleClick(params.row.id, 'above_360_dr')}>
            <p
              style={{
                color:
      ...
      renderCell: (params) => {
        return (
          <div onClick={() => handleClick(params.row.id, 'unsettled_cr')}>
            <p style={{ color: '#950909', whiteSpace: 'nowrap' }}>
